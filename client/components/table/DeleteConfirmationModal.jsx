...
const DeleteConfirmationModal = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h3 id="delete-title" className="text-base sm:text-lg font-bold mb-3 sm:mb-4">Confirm deletion</h3>
        <p className="text-sm sm:text-base text-secondary mb-4 sm:mb-6">Are you sure you want to delete this user?</p>
